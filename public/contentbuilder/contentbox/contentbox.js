...
(function (jQuery) {
    ...
    jQuery.contentbox = function (element, options) {
        ...
        var defaults = {
            ...
            iconselect: 'assets/ionicons/selecticon-dark.html',
        ...
        this.init = function () {
            ...
            for (var i = 0; i < oScripts.length; i++) {
                ...
                if (sSrc.indexOf("contentbox-src.js") != -1) $scriptpath = oScripts[i].src.replace(/contentbox-src.js/, "");
                if (sSrc.indexOf("contentbox.js") != -1) $scriptpath = oScripts[i].src.replace(/contentbox.js/, "");
            }
            var sScriptPathArray = $scriptpath.split("?");
            $scriptpath = sScriptPathArray[0];


            if (jQuery("#divSections").length == 0) {
                var s = '<div id="divSections" style="display:none"></div>' +
                '' +
		        '<div class="md-modal" id="md-addsection" style="display:none">' +
                ...
                '</div>' +
                '' +
                '<div class="md-modal" id="md-delsectionconfirm">' +
                    '<div class="md-content">' +
                        '<div class="md-body">' +
                            '<div style="padding:20px 20px 25px;text-align:center;">' +
                                '<p>Are you sure you want to delete this section?</p>' +
                                '<button class="cl-button uppercase" id="btnDelSectionCancel"> CANCEL </button>' +
                                '<button class="cl-button cl-button-primary uppercase" id="btnDelSectionOk" style="margin-left:12px"> OK </button>' +
                            '</div>' +
                        '</div>' +
                    '</div>' +
                '</div>' +
                '' +
                '<div class="md-modal md-draggable" id="md-editsection" style="display:none">' +
                    '<div class="md-content">' +
                        '<div class="md-body" style="padding:0 30px 30px">' +
                            '<div class="md-modal-handle" style="padding:10px 20px 0;">' +
                                '<div class="md-title" style="margin:0 0 12px;">Section Settings</div>' +
                            '</div>' +
                            '<div class="clearfix">' +
                                '<div class="is-boxes">' +
                                    '<div class="is-box-12">' +
                                ...
                                '<div class="is-boxes">' +
                                    '<div class="is-box-3">' +
                                        '<button class="cl-button cl-button-full cmd-section-top">Top</button>' +
                                    '</div>' +
                                    '<div class="is-box-3">' +
                                        '<button class="cl-button cl-button-full cmd-section-up">Up</button>' +
                                    '</div>' +
                                    '<div class="is-box-3">' +
                                        '<button class="cl-button cl-button-full cmd-section-down">Down</button>' +
                                    '</div>' +
                                    '<div class="is-box-3">' +
                                        '<button class="cl-button cl-button-full cmd-section-bottom">Bottom</button>' +
                                    '</div>' +
                                '</div>' +
                                '<div class="is-boxes"">' +
                                    '<div class="is-box-12">' +
                                ...
                                '<div class="is-boxes">' +
                                    '<div class="is-box-3">' +
                                        '<button class="cl-button cl-button-full cmd-section-height" data-value="0">Auto</button>' +
                                    '</div>' +
                                    '<div class="is-box-3">' +
                                        '<button class="cl-button cl-button-full cmd-section-height" data-value="20">20%</button>' +
                                    '</div>' +
                                    '<div class="is-box-3">' +
                                        '<button class="cl-button cl-button-full cmd-section-height" data-value="30">30%</button>' +
                                    '</div>' +
                                    '<div class="is-box-3">' +
                                        '<button class="cl-button cl-button-full cmd-section-height" data-value="40">40%</button>' +
                                    '</div>' +
                                '</div>' +
                                '<div class="is-boxes">' +
                                    '<div class="is-box-3">' +
                                        '<button class="cl-button cl-button-full cmd-section-height" data-value="50">50%</button>' +
                                    '</div>' +
                                    '<div class="is-box-3">' +
                                        '<button class="cl-button cl-button-full cmd-section-height" data-value="60">60%</button>' +
                                    '</div>' +
                                    '<div class="is-box-3">' +
                                        '<button class="cl-button cl-button-full cmd-section-height" data-value="75">75%</button>' +
                                    '</div>' +
                                    '<div class="is-box-3">' +
                                        '<button class="cl-button cl-button-full cmd-section-height" data-value="100">100%</button>' +
                                    '</div>' +
                                '</div>' +
                                '<div class="is-boxes">' +
                                    '<div class="is-box-6">' +
                                        '<div style="text-align:center;margin-top: 20px;">' +
                                            '<label for="chkScrollIcon" style="margin:0;"><input id="chkScrollIcon" type="checkbox" /> Scroll Icon</label>' +
                                        '</div>' +
                                    '</div>' +
                                    '<div class="is-box-3">' +
                                        '<button class="cl-button cl-button-full cmd-section-scroll" data-value="light">Light</button>' +
                                    '</div>' +
                                    '<div class="is-box-3">' +
                                        '<button class="cl-button cl-button-full cmd-section-scroll" data-value="dark">Dark</button>' +
                                    '</div>' +
                                '</div>' +
                            '</div>' +
                        '</div>' +
                ...
                '<div class="md-modal md-draggable" id="md-customcolor" style="display:none;cursor:move">' +
                    '<div class="md-content">' +
                        '<div class="md-body" style="padding:0">' +
                            '<div class="md-modal-handle" style="padding:0">' +
                                '<div style="margin:0;font-size:15px;line-height:22px;text-align:center;"><i class="cb-icon-dot"></i></div>' +
                            '</div>' +
                            '<input id="md-color-target" type="hidden" value="" />' +
                            '<input type="text" id="inpSectColor" value="rgb(0, 0, 0)"/>' +
                            '<div class="clearfix" style="overflow-y:auto;overflow-x:hidden;height:auto;max-height:575px;">' +
                                '<div class="is-boxes is-colorbuttons">' +
                                    ...
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#B71C1C" style="background:#B71C1C"></button></div>' +
                                '</div>' +
                                '<div class="is-boxes is-colorbuttons">' +
                                    ...
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#880E4F" style="background:#880E4F"></button></div>' +
                                '</div>' +
                                '<div class="is-boxes is-colorbuttons">' +
                                    ...
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#4A148C" style="background:#4A148C"></button></div>' +
                                '</div>' +
                                '<div class="is-boxes is-colorbuttons">' +
                                    ...
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#311B92" style="background:#311B92"></button></div>' +
                                '</div>' +
                                '<div class="is-boxes is-colorbuttons">' +
                                ...
                                '</div>' +
                                 '<div class="is-boxes is-colorbuttons">' +
                                    ...
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#0D47A1" style="background:#0D47A1"></button></div>' +
                                '</div>' +
                                '<div class="is-boxes is-colorbuttons">' +
                                    ...
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#01579B" style="background:#01579B"></button></div>' +
                                '</div>' +
                                '<div class="is-boxes is-colorbuttons">' +
                                    ...
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#006064" style="background:#006064"></button></div>' +
                                '</div>' +
                                '<div class="is-boxes is-colorbuttons">' +
                                    ...
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#004D40" style="background:#004D40"></button></div>' +
                                '</div>' +
                                '<div class="is-boxes is-colorbuttons">' +
                                    ...
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#1B5E20" style="background:#1B5E20"></button></div>' +
                                '</div>' +
                                '<div class="is-boxes is-colorbuttons">' +
                                    ...
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#33691E" style="background:#33691E"></button></div>' +
                                '</div>' +
                                '<div class="is-boxes is-colorbuttons">' +
                                    ...
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#827717" style="background:#827717"></button></div>' +
                                '</div>' +
                                '<div class="is-boxes is-colorbuttons">' +
                                    ...
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#F57F17" style="background:#F57F17"></button></div>' +
                                '</div>' +
                                '<div class="is-boxes is-colorbuttons">' +
                                ...
                                '</div>' +
                                '<div class="is-boxes is-colorbuttons">' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#FFF3E0" style="background:#FFF3E0"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#FFE0B2" style="background:#FFE0B2"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#FFCC80" style="background:#FFCC80"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#FFB74D" style="background:#FFB74D"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#FFA726" style="background:#FFA726"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#FF9800" style="background:#FF9800"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#FB8C00" style="background:#FB8C00"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#F57C00" style="background:#F57C00"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#EF6C00" style="background:#EF6C00"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#E65100" style="background:#E65100"></button></div>' +
                                '</div>' +
                                '<div class="is-boxes is-colorbuttons">' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#FBE9E7" style="background:#FBE9E7"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#FFCCBC" style="background:#FFCCBC"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#FFAB91" style="background:#FFAB91"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#FF8A65" style="background:#FF8A65"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#FF7043" style="background:#FF7043"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#FF5722" style="background:#FF5722"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#F4511E" style="background:#F4511E"></button></div>' +
                                    ...
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#BF360C" style="background:#BF360C"></button></div>' +
                                '</div>' +
                                '<div class="is-boxes is-colorbuttons">' +
                                    ...
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#3E2723" style="background:#3E2723"></button></div>' +
                                '</div>' +
                                '<div class="is-boxes is-colorbuttons">' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#ECEFF1" style="background:#ECEFF1"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#CFD8DC" style="background:#CFD8DC"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#B0BEC5" style="background:#B0BEC5"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#90A4AE" style="background:#90A4AE"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#78909C" style="background:#78909C"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#607D8B" style="background:#607D8B"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#546E7A" style="background:#546E7A"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#455A64" style="background:#455A64"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#37474F" style="background:#37474F"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#263238" style="background:#263238"></button></div>' +
                                '</div>' +
                                '<div class="is-boxes is-colorbuttons">' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#FAFAFA" style="background:#FAFAFA"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#F5F5F5" style="background:#F5F5F5"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#EEEEEE" style="background:#EEEEEE"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#E0E0E0" style="background:#E0E0E0"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#BDBDBD" style="background:#BDBDBD"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#9E9E9E" style="background:#9E9E9E"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#757575" style="background:#757575"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#616161" style="background:#616161"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#424242" style="background:#424242"></button></div>' +
                                    '<div class="is-box-1"><button class="cl-button cl-button-large cmd-box-customcolor" data-value="#212121" style="background:#212121"></button></div>' +
                                '</div>' +
                            '</div>' +
                        '</div>' +
                    '</div>' +
                '</div>' +
                '' +
                '<div class="md-modal md-draggable" id="md-editmodule" style="display:none">' +
                    '<div class="md-content">' +
                        '<div class="md-modal-handle" style="padding:7px 20px;">' +
                            '<div class="md-title" style="color:rgba(255,255,255,0.6);">Module Settings</div>' +
                        '</div>' +
                        '<div class="md-body">' +
                            '<iframe id="ifrModulePanel" style="width:100%;height:500px;border:none;" src="' + $scriptpath + 'images/blank.gif"></iframe>' +
                            '<input id="hidModuleCode" type="hidden" />' +
                            '<input id="hidModuleSettings" type="hidden" />' +
                        '</div>' +
					    '<div class="md-footer">' +
                            '<button id="btnModuleCancel" class="secondary"> Cancel </button>' +
                            '<button id="btnModuleOk" class="primary"> Ok </button>' +
                        '</div>' +
                    '</div>' +
                '</div>' +
                '' +
                '<div class="md-modal md-draggable" id="md-editbox" style="display:none">' +
                    '<div class="md-content">' +
                        '<div class="md-body" style="padding:0 30px 30px">' +
                            '<div class="md-modal-handle" style="padding:10px 20px 0;">' +
                                '<div class="md-title" style="margin:0 0 12px;">Box Settings</div>' +
                            '</div>' +
                            '<div class="is-tab-links" style="text-align:center;">' +
                                '<a id="tab-editbox-1" class="cl-tab active" data-tab-content="tab-content-editbox-1" href="#">Box Size</a> ' +
                                '<a id="tab-editbox-2" class="cl-tab" data-tab-content="tab-content-editbox-2" href="#">Background</a> ' +
                                '<a id="tab-editbox-3" class="cl-tab" data-tab-content="tab-content-editbox-3" href="#">Content Style</a> ' +
                                '<a id="tab-editbox-4" class="cl-tab" data-tab-content="tab-content-editbox-4" href="#" style="white-space:nowrap">Content Size</a> ' +
                                '<a id="tab-editbox-5" class="cl-tab" data-tab-content="tab-content-editbox-5" href="#" style="white-space:nowrap">Content Position</a> ' +
                                '<a id="tab-editbox-6" class="cl-tab" data-tab-content="tab-content-editbox-6" href="#">Image</a> ' +
                                '<a id="tab-editbox-7" class="cl-tab" data-tab-content="tab-content-editbox-7" href="#">Module</a> ' +
                                '<a id="tab-editbox-8" class="cl-tab" data-tab-content="tab-content-editbox-8" href="#">Animate</a> ' +
                                '<a id="tab-editbox-9" class="cl-tab" data-tab-content="tab-content-editbox-9" href="#" style="display:none">HTML</a> ' +
                            '</div>' +
                            '<div class="is-tab-contents" style="margin-top:30px">' +
                                '<div id="tab-content-editbox-1" class="clearfix">' +
                                    '<div class="is-boxes">' +
                                        '<div class="is-box-6">' +
                                            '<button class="cl-button cl-button-full cmd-box-smaller" style="font-size:22px;">-</button>' +
                                        '</div>' +
                                        '<div class="is-box-6">' +
                                            '<button class="cl-button cl-button-full cmd-box-larger" style="font-size:22px;">+</button>' +
                                        '</div>' +
                                    '</div>' +
                                '</div>' +
                                '<div id="tab-content-editbox-2" class="clearfix">' +
                                    '<div class="is-boxes">' +
                                        '<div class="is-box-2">' +
                                            '<button class="cl-button cl-button-full cmd-box-bgcolor" data-value="">Default</button>' +
                                        '</div>' +
                                        '<div class="is-box-2">' +
                                            '<button class="cl-button cl-button-full cmd-box-bgcolor" data-value="light">Light</button>' +
                                        '</div>' +
                                        '<div class="is-box-2">' +
                                            '<button class="cl-button cl-button-full cmd-box-bgcolor" data-value="grey">Grey</button>' +
                                        '</div>' +
                                        '<div class="is-box-2">' +
                                            '<button class="cl-button cl-button-full cmd-box-bgcolor" data-value="dark">Dark</button>' +
                                        '</div>' +
                                        '<div class="is-box-2">' +
                                            '<button class="cl-button cl-button-full cmd-box-pickbgcolor" data-value="dark"><i class="cb-icon-color"></i></button>' +
                                        '</div>' +
                                        '<div class="is-box-2" id="divBoxPickPhoto">' +
                                            '<button class="cl-button cl-button-full cmd-box-pickphoto" data-value=""><i class="cb-icon-picture"></i></button>' +
                                        '</div>' +
                                    '</div>' +
                                '</div>' +
                                '<div id="tab-content-editbox-3" class="clearfix">' +
                                    '<div class="is-boxes">' +
                                        '<div class="is-box-6">' +
                                            '<button class="cl-button cl-button-full cmd-box-textcolor" data-value="light">Light</button>' +
                                        '</div>' +
                                        '<div class="is-box-6">' +
                                            '<button class="cl-button cl-button-full cmd-box-textcolor" data-value="dark">Dark</button>' +
                                        '</div>' +
                                    '</div>' +
                                    '<div class="is-boxes">' +
                                        '<div class="is-box-4">' +
                                            '<button class="cl-button cl-button-full cmd-box-textalign" data-value="left"><i class="cb-icon-align-left"></i></button>' +
                                        '</div>' +
                                        '<div class="is-box-4">' +
                                            '<button class="cl-button cl-button-full cmd-box-textalign" data-value="center"><i class="cb-icon-align-center"></i></button>' +
                                        '</div>' +
                                        '<div class="is-box-4">' +
                                            '<button class="cl-button cl-button-full cmd-box-textalign" data-value="right"><i class="cb-icon-align-right"></i></button>' +
                                        '</div>' +
                                    '</div>' +
                                    '<div class="is-boxes">' +
                                        '<div class="is-box-12">' +
                                    ...
                                    '<div class="is-boxes">' +
                                        '<div class="is-box-4">' +
                                            '<button class="cl-button cl-button-full cmd-box-textopacity" data-value="+" style="font-size:22px;"> + </button>' +
                                        '</div>' +
                                        '<div class="is-box-4">' +
                                            '<button class="cl-button cl-button-full cmd-box-textopacity" data-value="-" style="font-size:22px;"> - </button>' +
                                        '</div>' +
                                        '<div class="is-box-4">' +
                                            '<button class="cl-button cl-button-full cmd-box-textopacity" data-value="">Not Set</button>' +
                                        '</div>' +
                                    '</div>' +
                                '</div>' +
                                '<div id="tab-content-editbox-4" class="clearfix">' +
                                    '<div class="is-boxes">' +
                                        '<div class="is-box-3">' +
                                            '<button class="cl-button cl-button-full cmd-box-size" data-value="380">380px</button>' +
                                        '</div>' +
                                        '<div class="is-box-3">' +
                                            '<button class="cl-button cl-button-full cmd-box-size" data-value="500">500px</button>' +
                                        '</div>' +
                                        '<div class="is-box-3">' +
                                            '<button class="cl-button cl-button-full cmd-box-size" data-value="640">640px</button>' +
                                        '</div>' +
                                        '<div class="is-box-3">' +
                                            '<button class="cl-button cl-button-full cmd-box-size" data-value="800">800px</button>' +
                                        '</div>' +
                                    '</div>' +
                                    '<div class="is-boxes">' +
                                        '<div class="is-box-3">' +
                                            '<button class="cl-button cl-button-full cmd-box-size" data-value="980">980px</button>' +
                                        '</div>' +
                                        '<div class="is-box-3">' +
                                            '<button class="cl-button cl-button-full cmd-box-size" data-value="1050">1050px</button>' +
                                        '</div>' +
                                        '<div class="is-box-3">' +
                                            '<button class="cl-button cl-button-full cmd-box-size" data-value="1100">1100px</button>' +
                                        '</div>' +
                                        '<div class="is-box-3">' +
                                            '<button class="cl-button cl-button-full cmd-box-size" data-value="1200">1200px</button>' +
                                        '</div>' + /*
                                        '<div class="is-box-3">' +
                                            '<button class="cl-button cl-button-full cmd-box-size" data-value="0">Not Set</button>' + 
                                        '</div>' + */
                                    '</div>' +
                                '</div>' +
                                '<div id="tab-content-editbox-5" class="clearfix">' +
                                    '<div class="is-boxes">' +
                                        '<div class="is-box-4">' +
                                            '<button class="cl-button cl-button-full cmd-box-content-pos" data-value="topleft">&#8598;</button>' +
                                        '</div>' +
                                        '<div class="is-box-4">' +
                                            '<button class="cl-button cl-button-full cmd-box-content-pos" data-value="topcenter">&#8593;</button>' +
                                        '</div>' +
                                        '<div class="is-box-4">' +
                                            '<button class="cl-button cl-button-full cmd-box-content-pos" data-value="topright">&#8599;</button>' +
                                        '</div>' +
                                    '</div>' +
                                    '<div class="is-boxes">' +
                                        '<div class="is-box-4">' +
                                            '<button class="cl-button cl-button-full cmd-box-content-pos" data-value="middleleft">&#8592;</button>' +
                                        '</div>' +
                                        '<div class="is-box-4">' +
                                            '<button class="cl-button cl-button-full cmd-box-content-pos" data-value="middlecenter">&#9737;</button>' +
                                        '</div>' +
                                        '<div class="is-box-4">' +
                                            '<button class="cl-button cl-button-full cmd-box-content-pos" data-value="middleright">&#8594;</button>' +
                                        '</div>' +
                                    '</div>' +
                                    '<div class="is-boxes">' +
                                        '<div class="is-box-4">' +
                                            '<button class="cl-button cl-button-full cmd-box-content-pos" data-value="bottomleft">&#8601;</button>' +
                                        '</div>' +
                                        '<div class="is-box-4">' +
                                            '<button class="cl-button cl-button-full cmd-box-content-pos" data-value="bottomcenter">&#8595;</button>' +
                                        '</div>' +
                                        '<div class="is-box-4">' +
                                            '<button class="cl-button cl-button-full cmd-box-content-pos" data-value="bottomright">&#8600;</button>' +
                                        '</div>' +
                                    '</div>' +
                                    '<div class="is-boxes">' +
                                        '<div class="is-box-12">' +
                                    ...
                                    '<div class="is-boxes">' +
                                        ...
                                        '</div>' +
                                        '<div class="is-box-4">' +
                                            '<button class="cl-button cl-button-full cmd-box-content-edge-y" data-value="-">-</button>' +
                                        '</div>' +
                                        '<div class="is-box-4">' +
                                            '<button class="cl-button cl-button-full cmd-box-content-edge-y" data-value="+">+</button>' +
                                        '</div>' +
                                        '<div class="is-box-2">' +
                                            '<button class="cl-button cl-button-full cmd-box-content-edge-y" data-value="">Default</button>' +
                                        '</div>' +
                                    '</div>' +
                                    '<div class="is-boxes">' +
                                        '<div class="is-box-2">' +
                                        ...
                                        '</div>' +
                                        '<div class="is-box-4">' +
                                            '<button class="cl-button cl-button-full cmd-box-content-edge-x" data-value="-">-</button>' +
                                        '</div>' +
                                        '<div class="is-box-4">' +
                                            '<button class="cl-button cl-button-full cmd-box-content-edge-x" data-value="+">+</button>' +
                                        '</div>' +
                                        '<div class="is-box-2">' +
                                            '<button class="cl-button cl-button-full cmd-box-content-edge-x" data-value="">Default</button>' +
                                        '</div>' +
                                    '</div>' +
                                '</div>' +
                                '<div id="tab-content-editbox-6" class="clearfix">' +
                                    '<div class="is-boxes">' +
                //added by jack
										...
										'<div class="is-box-6">' +
                                            '<div style="text-align:center">' +
                                                '<button class="cl-button cl-button-full cmd-box-selectasset">Select Image</button>' +
                                                '<br />' +
                                            '</div>' +
                                        '</div>' +
                                        '<div class="is-box-6">' +
                                            '<div style="text-align:center">' +
                                                '<label for="chkAnimateBg" style="margin:0;"><input id="chkAnimateBg" type="checkbox" /> Ken Burns Effect</label>' +
                                                '<br />' +
                                            '</div>' +
                                        '</div>'
										:
                ...
                //end of added by jack
                                    ...
                                    '<div class="is-boxes">' +
                                        '<div class="is-box-3">' +
                                            '<button class="cl-button cl-button-full cmd-box-overlaycolor" data-value="#ffffff">White</button>' +
                                        '</div>' +
                                        '<div class="is-box-3">' +
                                            '<button class="cl-button cl-button-full cmd-box-overlaycolor" data-value="#000000">Black</button>' +
                                        '</div>' +
                                        '<div class="is-box-3">' +
                                            '<button class="cl-button cl-button-full cmd-box-pickoverlaycolor"><i class="cb-icon-color"></i></button>' +
                                        '</div>' +
                                        '<div class="is-box-3">' +
                                            '<button class="cl-button cl-button-full cmd-box-overlaycolor" data-value="">Not Set</button>' +
                                        '</div>' +
                                    '</div>' +
                                    '<div class="is-boxes">' +
                                        '<div class="is-box-12">' +
                                    ...
                                    '<div class="is-boxes">' +
                                        '<div class="is-box-4">' +
                                            '<button class="cl-button cl-button-full cmd-box-overlay" data-value="+" style="font-size:22px">+</button>' +
                                        '</div>' +
                                        '<div class="is-box-4">' +
                                            '<button class="cl-button cl-button-full cmd-box-overlay" data-value="-" style="font-size:22px">-</button>' +
                                        '</div>' +
                                        '<div class="is-box-4">' +
                                            '<button class="cl-button cl-button-full cmd-box-overlay" data-value="0">None</button>' +
                                        '</div>' +
                                    '</div>' +
                                '</div>' +
                                '<div id="tab-content-editbox-7" class="clearfix">' +
                                    '<div class="is-boxes">' +
                                        '<div class="is-box-12">' +
                                            '<div style="text-align:center">' +
                                                '<label for="chkBgModule" style="margin:0;"><input id="chkBgModule" type="checkbox" /> Module Placement</label>' +
                                            '</div>' +
                                        '</div>' +
                                    '</div>' +
                                '</div>' +
                                '<div id="tab-content-editbox-8" class="clearfix">' +
                                    '<div class="is-boxes">' +
                                        '<div class="is-box-12">' +
                                            '<div style="text-align:center">' +
                                                ...
                                                '</select>' +
                                                '<button class="cl-button cmd-box-animate-test">Test</button>' +
                                                '<label for="chkAnimOnce" style="margin:10px 0 0;"><input id="chkAnimOnce" type="checkbox" /> Once</label>' +
                                            '</div>' +
                                        '</div>' +
                                    '</div>' +
                                '</div>' +
                                '<div id="tab-content-editbox-9" class="clearfix">' +
                                    '<div class="is-boxes">' +
                                        '<div class="is-box-12">' +
                                            '<div style="text-align:center">' +
                                                '<textarea id="inpBoxHtml" style="width:100%;height:100%;min-height:200px;max-height:220px;border:#eee 1px solid;"></textarea>' +
                                                '<button class="cl-button cl-button-full cmd-box-html">Apply</button>' +
                                            '</div>' +
                                        '</div>' +
                                    '</div>' +
                                '</div>' +
                            '</div>' +
                            '<p id="divNoBoxSettings" style="text-align: center;display:none;">This box has no available settings.</p>' +
                        '</div>' +
                    '</div>' +
                '</div>' +
                '' +
		        '<div class="md-modal md-draggable" id="md-icon-list" style="display:none">' +
                    '<div class="md-content">' +
                        '<div class="md-body">' +
                            '<div class="md-modal-handle">' +
                                '<div style="margin:0;font-size:15px;line-height:22px;text-align:center;"><i class="cb-icon-dot"></i></div>' +
                            '</div>' +
                            '<iframe id="ifrIconList" style="width:100%;height:500px;border:none;" src="' + $scriptpath + 'images/blank.gif"></iframe>' +
                        '</div>' +
                    '</div>' +
                '</div>' +
                '' +
		        '<div class="md-modal" id="md-view-html" style="display:none;">' +
                    '<div class="md-content" style="height:100%">' +
                        '<div class="md-body" style="height:100%;border-bottom:rgba(0,0,0,0) 55px solid;box-sizing:border-box;">' +
					    ...
					    '<div class="md-footer" style="position:absolute;width:100%;height:55px;left:0;bottom:0;">' +
                            '<button id="btnViewHtmlCancel" class="secondary"> Cancel </button>' +
                            '<button id="btnViewHtmlOk" class="primary"> Ok </button>' +
                        '</div>' +
                    '</div>' +
                '</div>' +
                '' +
		        '<div class="md-modal md-draggable" id="md-pickphoto" style="display:none;">' +
                    '<div class="md-content">' +
                        '<div class="md-body">' +
                            '<div class="md-modal-handle">' +
                                '<div style="margin:0;font-size:15px;line-height:22px;text-align:center;"><i class="cb-icon-dot"></i></div>' +
                            '</div>' +
                            '<iframe id="ifrPhotoList" style="width:100%;height:580px;border:none;background:rgba(0,0,0,0.9);" src="' + $scriptpath + 'images/blank.gif"></iframe>' +
                        '</div>' +
                    '</div>' +
                '</div>' +
                '';
            ...
            if (jQuery("#divboxtool").length == 0) {
                var s = '<div id="divboxtool" style="display:none;z-index:10;position:absolute;box-sizing: border-box;width: 60px;line-height:30px;outline: none;text-align: center;cursor: pointer;border-radius:4px;overflow:hidden;border-top-left-radius:4px;border-top-right-radius:4px;">' +
			        '<form id="form-upload-cover" target="frame-upload-cover" method="post" action="' + this.settings.coverImageHandler + '" enctype="multipart/form-data" style="position:relative;width:30px;height: 30px;display:inline-block;float:left;background: rgb(90, 156, 38);">' +						csrf_field +
				        '<i class="cb-icon-camera" style="position: relative;display: block;font-size: 16px;color:#fff;cursor:pointer;overflow: hidden;">' +
					        '<input type="file" id="fileCover" name="fileCover" style="position:absolute;top:0;left:-10px;width:45px;height:65px;top:-20px;margin: 0;cursor: pointer;opacity: 0.01;display: inline-block;">' +
				        '</i>' +
				        '<input id="hidcustomval" name="hidcustomval" type="hidden" value="" />' +
                        '<iframe id="frame-upload-cover" name="frame-upload-cover" src="' + $scriptpath + 'images/blank.gif" style="width:1px;height:1px;position:absolute;top:0;right:-100000px"></iframe>' +
			        '</form>' +
                    '<div id="lnkeditbox" style="display:inline-block;width:30px;height:30px;background: rgb(0, 172, 214);"><i class="cb-icon-wrench" style="display:block;font-size: 16px;color:#fff;"></i></div>' +
                    '<div id="lnkeditmodule" style="display:inline-block;width:30px;height:30px;background: #FF9800;"><i class="cb-icon-cog" style="display:block;font-size: 16px;color:#fff;"></i></div>' +
		        '</div>';
                jQuery('body').append(s);
            }
        ...
        this.setup = function () {
            ...
            var snippetCustomCode = this.settings.snippetCustomCode;
            var snippetCustomCodeMessage = this.settings.snippetCustomCodeMessage;
            ...
            $element.children().each(function () {
                ...
                $currentSection.find('.is-builder').each(function () {
                    ...
                    jQuery(this).contentbuilder({
                        ...
                        snippetCustomCode: snippetCustomCode,
                        snippetCustomCodeMessage: snippetCustomCodeMessage,
        ...
        this.addSection = function () {
            ...
            this.settings.onAddSectionOpen(); //Trigger onAddSectionOpen event
            //jQuery('#md-addsection').css('max-width', '870px');
            jQuery('#md-addsection').css('max-width', '1422px');
            ...
            jQuery('.section-list > div').click(function (e) {
                ...
                $newSection.find('.is-builder').each(function () {
                    ...
                    jQuery('#' + newId).contentbuilder({
                        ...
                        snippetCustomCode: $element.data("contentbox").settings.snippetCustomCode,
                        snippetCustomCodeMessage: $element.data("contentbox").settings.snippetCustomCodeMessage,
        ...
        this.contentRender = function () {
            ...
            $element.addClass('use-select-icon');
            $element.find('.ui-draggable > div:first-child i').each(function () {
            if (jQuery(this).html() == '') {
            jQuery(this).unbind('click');
            jQuery(this).click(function () {
            $activeIcon = jQuery(this);
            jQuery('#ifrIconList').attr('src', iconselect);
            jQuery('#md-icon-list').css('max-width', '775px');
            jQuery('#md-icon-list').simplemodal();
            jQuery('#md-icon-list').data('simplemodal').show();
            });
            }
            });
            }*/
        ...
        this.applyBoxBehavior = function () {
            ...
            jQuery(".is-box").hover(function (e) {
                ...
                if ($box.find(".is-overlay-bg").length == 0) {
                    ...
                    if ($box.find('.is-overlay-content[data-module]').length > 0) {
                        jQuery("#lnkeditmodule").css("display", "inline-block");
                        jQuery("#divboxtool").css("width", "90px");
                        leftadj = 45;
                    } else {
                        jQuery("#lnkeditmodule").css("display", "none");
                        jQuery("#divboxtool").css("width", "60px");
                ...
                */
                ...
                jQuery("#lnkeditmodule").unbind('click');
                jQuery("#lnkeditmodule").click(function (e) {
            ...
            //Add dummy DIV after the last section
        ...
        this.editModule = function () {
            ...
            $element.find(".is-overlay-content[data-module]").removeAttr('data-module-active');
            $activeModule.attr('data-module-active', '1');

            var moduleName = $activeModule.attr('data-module');

            jQuery('#ifrModulePanel').attr('src', $scriptpath + 'modules/' + moduleName + '.html'); //load module panel on iframe

            var moduleDesc = $activeModule.attr('data-module-desc');
            if (moduleDesc) {
                jQuery("#md-editmodule").find('.md-title').html(moduleDesc);
            } else {
                jQuery("#md-editmodule").find('.md-title').html('Module Settings');
            }

            jQuery("#md-editmodule").css("width", "60%");
            jQuery("#md-editmodule").simplemodal({ isModal: true });
            jQuery("#md-editmodule").data("simplemodal").show();

            jQuery('#btnModuleOk').unbind('click');
            jQuery('#btnModuleOk').bind('click', function (e) {
                ...
                jQuery('#md-editmodule').data('simplemodal').hide();

            });

            jQuery('#btnModuleCancel').unbind('click');
            jQuery('#btnModuleCancel').bind('click', function (e) {
        ...
        this.editBox = function () {
            if ($activeBox.find(".is-overlay-bg").length == 0) {
                ...
                jQuery("#tab-editbox-7").css("display", "none"); //hide chkBgModule
            ...
            if ($activeBox.find(".is-container").length == 0) { //has content
            ...
            if ($activeBox.find(".is-module").length > 0) {//If is module   
                ...
                //jQuery("#tab-editbox-2").css("display", "inline"); //show Background tab
            ...
            if (jQuery("#tab-editbox-1").css("display") == "none" &&
                jQuery("#tab-editbox-2").css("display") == "none" &&
                jQuery("#tab-editbox-3").css("display") == "none" &&
                jQuery("#tab-editbox-4").css("display") == "none" &&
                jQuery("#tab-editbox-5").css("display") == "none" &&
                ...
                jQuery("#tab-editbox-7").css("display") == "none" &&
                jQuery("#tab-editbox-8").css("display") == "none" &&
                jQuery("#tab-editbox-9").css("display") == "none") {

                jQuery(".is-tab-contents > div").css("display", "none"); //hide all tab contents
        ...
        this.boxOverlay = function (s) {
            ...
            if (s == "+") {
                ...
                $overlaycolor.css("display", "block");
                if ($overlaycolor.css("opacity") == 0.1) { $overlaycolor.css("opacity", ""); $overlaycolor.css("display", "none"); }
                ...
                else { $overlaycolor.css("opacity", ""); $overlaycolor.css("display", "none"); }
            }
            else if (s == "0") {
        ...
        this.html = function (bForView) {
            ...
            $element.children().each(function () {
                ...
                //*********** CUSTOMCODE ***********
                var hash = {};
                $currentSection.find("[data-module]").each(function () {//Mode: code
                    if (jQuery(this).attr("data-html") != undefined) {

                        var codekey = 'CODE' + makeid();
                        hash[codekey] = decodeURIComponent(jQuery(this).attr("data-html"));
                        jQuery(this).html('###' + codekey + '###');

                        //For View
                        if (bForView) {
                            var codekey2 = 'HTML' + makeid();
                            arrCustomCode[codekey2] = jQuery(this).attr("data-html");
                            jQuery(this).attr("data-html", "###" + codekey2 + "###");
                        }
                ...
                */
                ...
                //*********** CUSTOMCODE ***********
                for (var key in hash) {
                    sHtml = sHtml.replace('###' + key + '###', hash[key]);
                }
                ...
                $currentSection.find("[data-module]").each(function () {//Mode: code
                    if (jQuery(this).attr("data-html") != undefined) {
                        ...
                        //alert(jQuery(this).attr("data-html")) => ###codekey### (remove # first)
                        var codekey = jQuery(this).attr("data-html").replace(/#/g, "");
                        jQuery(this).html(decodeURIComponent(arrCustomCode[codekey]));

                        jQuery(this).attr("data-html", arrCustomCode[codekey]);
                    }
                });
                //*********** /CUSTOMCODE ***********
            ...
            //Add again dummy DIV after last section
            if ($element.children('div').not('.is-section').length == 0) {
                $element.append('<div style="height:1px"></div>');
            } else {
        ...
        this.viewHtml = function (s) {
            var sHtml = this.html(true); //For View
            /*
            sHtml = sHtml.replace(/row clearfix/g, 'mdl-grid');
            sHtml = sHtml.replace(/column full/g, 'mdl-cell mdl-cell--12-col');
            sHtml = sHtml.replace(/column half/g, 'mdl-cell mdl-cell--6-col');
            sHtml = sHtml.replace(/column third/g, 'mdl-cell mdl-cell--4-col');
            sHtml = sHtml.replace(/column fourth/g, 'mdl-cell mdl-cell--3-col');
            sHtml = sHtml.replace(/column fifth/g, 'mdl-cell mdl-cell--2-col');
            sHtml = sHtml.replace(/column sixth/g, 'mdl-cell mdl-cell--2-col');
            sHtml = sHtml.replace(/column two-third/g, 'mdl-cell mdl-cell--8-col');
            sHtml = sHtml.replace(/column two-fourth/g, 'mdl-cell mdl-cell--9-col');
            sHtml = sHtml.replace(/column two-sixth/g, 'mdl-cell mdl-cell--10-col');
            sHtml = sHtml.replace(/btn btn-primary/g, 'mdl-button mdl-js-button mdl-button--raised mdl-button--accent');
            sHtml = sHtml.replace(/btn btn-default/g, 'mdl-button mdl-js-button mdl-button--raised');
            sHtml = sHtml.replace(/social edit/g, 'edit');*/

            jQuery("#md-view-html").css("max-width", "90%");
            jQuery("#md-view-html").css("height", "90%");
            jQuery("#md-view-html").simplemodal({ isModal: true });
            jQuery("#md-view-html").data("simplemodal").show();

            jQuery('#inpViewHtml').val(sHtml);

            jQuery('#btnViewHtmlOk').unbind('click');
            jQuery('#btnViewHtmlOk').click(function () {
                ...
                var sHtml = jQuery('#inpViewHtml').val();
                //For View  
                for (var key in arrCustomCode) {
                    sHtml = sHtml.replace('###' + key + '###', arrCustomCode[key]);
                }
                jQuery('.is-wrapper').html(sHtml);
                ...
                $element.children().each(function () {
                    ...
                    var snippetCustomCode = $element.data("contentbox").settings.snippetCustomCode;
                    var snippetCustomCodeMessage = $element.data("contentbox").settings.snippetCustomCodeMessage;
            ...
            jQuery('#btnViewHtmlCancel').unbind('click');
