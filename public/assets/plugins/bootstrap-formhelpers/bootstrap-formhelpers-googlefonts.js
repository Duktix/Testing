 ...
 * ========================================================== */
  ...
  * ====================== */
  ...
  BFHGoogleFonts.prototype = {
    ...
    , addBootstrapFonts: function() {
      ...
      $options.html('')
      $options.append('<li><a tabindex="-1" href="#" data-option="" style="background-image: none;text-indent: -9px;font-size: 17px;">Default</a></li>')
      for (var f in this.familyList) {
        var entry = this.familyList[f];
  ...
  * ============== */
  ...
  $(window).on('load', function () {
    $('div.bfh-googlefonts').each(function () {
